...
set key left bottom box height 1    # położenie legendy na wykresach
...
f_slope(x) = a*log10(1/x) + b       # funkcja opisująca zbocze
f_inv_slope(k) = 10**(-(k-b)/a)     # funkcja odwrotna do zbocza

fit [f_g_fit+f_fit_range_low_corr:] f_slope(x) data_file using 1:(dB($2)) via b
